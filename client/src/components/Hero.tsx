...
const Hero = () => {
  return (
    <div className="relative overflow-hidden bg-black sm:pt-56 pt-32 lg:pb-20 pb-96">
               <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
                 <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                   <div className="sm:max-w-lg">
                     <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl capitalize">
                       Every moment is data saved in memory — .
                     </h1>
                     <p className="mt-4 text-xl text-gray-500">
                          Automating media production and delivery for users, brands and creatives. Manage & organize your journey
                     </p>
                   </div>
                   <div>
                     <div className="mt-10">
                       ...
                       >
                         <div className="absolute transform sm:top-0 pt-52 lg:pt-0 sm:left-1/2 sm:translate-x-8 lg:top-1/2 lg:left-1/2 lg:translate-x-8 lg:-translate-y-1/2">
                       ...
                       <Link
                         href="#"
                         className="inline-block mb-10 rounded-md border border-transparent bg-white px-8 py-3 text-center font-semibold text-black hover:bg-white/25"
                       >
                         Organize your journey
                          </Link>
                          
                          <div className='flex items-center gap-4'>
                              <p className='text-white text-[20px] font-semibold'>Over +2,500 users </p><GroupIcons />
                          </div>
                     </div>
                   </div>
                 </div>
