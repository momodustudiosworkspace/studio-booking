  ...
  return (
    <div className='mx-5 flex max-w-7xl flex-col gap-8 rounded-lg sm:mx-auto sm:flex-row lg:p-8'>
      <div>
        ...
        <p className='sm:w-[60%]'>
          Explore our range of professional studio services designed to meet all
          your creative needs. From state-of-the-art equipment rentals to expert
          technical support, we provide everything you need to bring your vision
          to life
        </p>
        <ul
          role='list'
      ...
      <ul
        role='list'
        className='divide-y divide-white/5 rounded-lg bg-black p-4 pl-2 sm:w-full lg:w-[60%]'
      >
        {people.map(person => (
