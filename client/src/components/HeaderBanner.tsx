  ...
  return (
      <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-800/50 px-6 py-2.5 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 sm:px-3.5 sm:before:flex-1">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
              <p className="text-sm/6 text-gray-100 flex items-center">
                  <strong className="font-semibold">Studio Space Available</strong>
                 
                  <span className='hidden sm:inline-flex items-center'> <svg viewBox="0 0 2 2" aria-hidden="true" className="mx-2 inline size-0.5 fill-current">
                      <circle r={1} cx={1} cy={1} />
                  </svg> Book your creative space in our premium studios for music, photography, and podcasts. Limited availability!</span>
              </p>
              <a
                  href="#"
