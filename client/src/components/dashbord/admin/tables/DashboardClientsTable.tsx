...
const DashboardClientsTable = ({
    users, isLoading }: ClientTableProps) => {
     const [open, setOpen] = useState<boolean>(false);
    const [selectedUserId, setSelectedUserId] = useState<UserTypesResponse | null>(null);
    return (
        <div className="w-full relative rounded-xl bg-white">
            {/* Table */}
                        ...
                        {isLoading ? (
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    <td className="px-4 py-5 max-w-[200px] truncate">{user.email}</td>
                                    ...
                                    <td className="px-4 py-5 flex items-center gap-2 capitalize">
                                        ...
                                        <div>
                                            ...
                                            <td className="px-4 py-5 capitalize text-center">{user.totalBookings}</td>

                                    <td className="px-4 py-5">
                                        <span
                                            className={`rounded-full px-3 py-1 text-xs font-medium capitalize ${user.isMember 
                    ...
                    <div className='max-h-[700px] overflow-y-scroll'>
                        <div className='mb-7 hidden items-center gap-4 sm:flex'>
                            ...
                            <div>
                                ...
                                <small>{selectedUserId?.isMember ? "Premuim account" : 'Free account'}</small>
                            </div>
                        </div>
                        {/* <LinkButton
                        ...
                        <div className='mb-5 rounded-md border-[1px] border-[#E5E5E5]'>
                            ...
                            <div className='flex flex-col gap-3 p-4'>
                                <div className='flex items-center justify-between capitalize'>
                                    <p>full name</p>
                                    <p>{selectedUserId?.first_name} {selectedUserId?.last_name}</p>
                                </div>
                                <div className='flex items-center justify-between'>
                                    <p className='capitalize'>email address</p>
                                    <p className="max-w-[150px] truncate">{selectedUserId?.email}</p>
                                </div>
                                <div className='flex items-center justify-between capitalize'>
                                    <p>phone number</p>
                                    <p>{selectedUserId?.phoneNumber? selectedUserId.phoneNumber : "N/A"}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='rounded-md border-[1px] border-[#E5E5E5]'>
                            ...
                            <div className='flex flex-col gap-3 p-4'>
                                <div className='flex items-center justify-between capitalize'>
                                    <p>join date</p>
                                    <p>{selectedUserId?.createdAt ? formatDate(selectedUserId.createdAt) : "N/A"}</p>
                                </div>
                                <div className='flex items-center justify-between capitalize'>
                                    <p>status</p>
                                ...
                                <div className='flex items-center justify-between capitalize'>
                                    <p>total booking</p>
                                    <p className='font-semibold'>{selectedUserId?.totalBookings} booking{selectedUserId?.totalBookings && selectedUserId.totalBookings >1 ? "s" : ""}</p>
                                </div>
                            </div>
                        </div>
                    </div>
