                        ...
                        {isLoading ? (
                            ...
                            staffList.map(staff => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-5">
                                        <span
                                            className={`rounded-full px-3 py-1 text-xs font-medium ${staff.status === "active"
                                    ...
                                    <td className="px-4 py-5">
                                        <span
                                            className={`rounded-full px-3 py-1 text-xs font-medium capitalize ${staff.isInvitationAccepted
                                                    ? "bg-green-100 text-green-700"
                                                    : "bg-yellow-100 text-yellow-700"
                                                }`}
                                        >
