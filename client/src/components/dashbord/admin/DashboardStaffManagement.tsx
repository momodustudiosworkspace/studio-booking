...
const DashboardStaffManagement = () => {
    ...
    return (
        ...
        >
            ...
            <div className='mb-14 grid w-full gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4'>
            ...
            <div className='space-y-8'>
                ...
                <div className='rounded-lg '>
                    <div className='mb-6 flex items-center justify-between rounded-lg shadow bg-white p-6'>
                        <div>
                            <h2 className='text-xl font-bold text-black'>Manage Staff</h2>
                            <p className='mt-1 text-sm text-gray-600'>Create and manage your studio team members</p>
                        </div>
                        <Button
                            text='+ Add new staff'
                                        ...
                                        <div className='mb-5 sm:flex sm:items-center'>
                                            ...
                                            <div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'>
                                                ...
                                                >
                                                    ...
                                                    <small>
                                                        Enter staff details to add a new team member to your studio.
                                                    </small>
                                                </DialogTitle>
                                            </div>
                                        </div>
