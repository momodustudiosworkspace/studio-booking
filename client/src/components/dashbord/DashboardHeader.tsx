...
const DashboardHeader = ({
  ...
  return (
      <div className='flex sm:justify-between sm:flex-row flex-col gap-5 sm:items-end w-full'>
          <div>
              <div className='flex items-center gap-3'>
                  <h1 className='sm:text-[24px] text-[22px] capitalize font-bold'>{headerText}</h1>
