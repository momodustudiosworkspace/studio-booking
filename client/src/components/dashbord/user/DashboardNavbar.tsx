...
const DashboardNavbar = () => {
  ...
  const userNavigation = [
    { name: 'Profile', href: '/dashboard/profile-settings', type: "link" },
  ...
  return (
    ...
    //   </nav>
    // </div>
    <Disclosure as="nav" className="w-full bg-black mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <div className="">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="-mr-2 flex md:hidden">
            {/* Mobile menu button */}
            <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-white/5 hover:text-white focus:outline-2 focus:outline-offset-2 focus:outline-white">
