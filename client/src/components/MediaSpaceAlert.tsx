                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-400">
                                                Your media storage has reached its limit. To continue uploading and storing media files, please consider upgrading your plan or deleting unnecessary files.
                                            </p>
                                        </div>
                                    </div>
                                </div>
...
export default MediaSpaceAlert