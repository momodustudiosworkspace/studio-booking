      ...
      <section className='w-full'>
        ...
        <div className='mb-10 flex flex-col gap-6 px-5'>
          <div className='flex items-start gap-3'>
            <h1 className='font-montserrat text-[30px] font-extrabold uppercase'>
              Momodu studios
            </h1>
            <CopyRight />
          </div>
        ...
        <div className='relative mb-30 flex items-center justify-between'>
          <Image
        ...
        <div className='bg-black px-5 py-10 text-white'>
          <Portfolio />
          <div className='mt-10 flex flex-col gap-8 pr-24 pl-5'>
            {BOOK_SESSION.map((book, key) => (
              <div key={key} className='flex flex-col gap-2'>
                <h3 className='text-[16px] font-semibold capitalize'>
                  {book.title}
                </h3>
                <p className='text-xs text-[#AAAAAA]'>{book.description}</p>
              </div>
            ))}
        ...
        <div className='mb-20 flex flex-col items-center justify-between'>
          ...
          <div className='mt-8 mb-8 flex w-full flex-col gap-5 pr-10 pl-5'>
            <SectionHeader
              badgeWidth='w-[100px]'
